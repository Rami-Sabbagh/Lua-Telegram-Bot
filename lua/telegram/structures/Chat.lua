...
-- @raise error on failure.
function Chat:editMessageText(messageID, text, parseMode, disableWebPagePreview, replyMarkup)
    return call("editMessageText", self.id, messageID, nil, text, parseMode, disableWebPagePreview, replyMarkup)
end
